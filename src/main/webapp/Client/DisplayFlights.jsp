...
<div class="p-10">
    <div class="max-w-full  bg-white flex flex-col rounded overflow-hidden shadow-lg">
        <div class="flex flex-row items-baseline flex-nowrap bg-gray-100 p-2">
            <svg viewBox="0 0 64 64" data-testid="tripDetails-bound-plane-icon" pointer-events="all" aria-hidden="true"
                 class="mt-2 mr-1" role="presentation" style="fill: rgb(102, 102, 102); height: 0.9rem; width: 0.9rem;">
            ...
            <p class="ml-2 font-normal text-gray-500"><%=flight.getFlightDate()%> <%=flight.getTakeoff()%>
            </p>
        </div>
        ...
        <div class="mt-2 flex sm:flex-row mx-6 sm:justify-between flex-wrap ">
            ...
            <div class="flex flex-col p-2">
                <p class="font-bold"><%=flight.getTakeoff()%>
                </p>
                <p class="text-gray-500"><span class="font-bold"><%=flight.getDepartureCity()%></span></p>
            </div>
            <div class="flex flex-col flex-wrap p-2">
                <p class="font-bold"><%=flight.getLanding()%>
                </p>
                <p class="text-gray-500"><span class="font-bold"><%=flight.getArrivalCity()%></span></p>
            </div>
        </div>
        <div class="mt-4 bg-gray-100 flex flex-row flex-wrap md:flex-nowrap justify-between items-baseline">
            <div class="md:border-l-2 mx-6 md:border-dotted flex flex-row py-4 mr-6 flex-wrap">
                <svg class="w-12 h-10 p-2 mx-2 self-center bg-green-800 rounded-full fill-current text-white etiIcon css-ecvhkc"
                ...
                <div class="text-sm mx-2 flex flex-col">
                    <p>Flexible Ticket</p>
                    <p class="font-bold"><%=flight.getPrice()%>
                    </p>
                ...
                <form action="${pageContext.request.contextPath}/book-flight" method="post">
                    ...
                    <button class="w-32 h-11 rounded flex border-solid border text-white bg-green-800 mx-2 justify-center place-items-center"
                            type="button" data-modal-toggle="flight<%=flight.getId()%>">
                        Book
                    </button>

                    <!-- Main modal -->
                    <div id="flight<%=flight.getId()%>" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                                    ...
                                    <button type="button"
                                            ...
                                            data-modal-toggle="flight<%=flight.getId()%>">
                                ...
                                <div class="p-6 space-y-6 text-white">
                                    <form class="space-y-4 md:space-y-6"
                                          action="${pageContext.request.contextPath}/book-flight" method="post">
                                        <input name="idFlight" value="<%=flight.getId()%>" type="text" hidden/>
                                        <div>
                                            <label for="fullname"
